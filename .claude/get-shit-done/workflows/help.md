...
- Saves timestamped note to `.planning/notes/` (or `/mnt/d/05_Learning/Courses/AI/udemy/AI Coder Complete Claude Code & Coding Agents Course/Project_Files/finally/.claude/notes/` globally)
