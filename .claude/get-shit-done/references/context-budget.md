...
The keys live in `.claude/settings.json` (project) or `/mnt/d/05_Learning/Courses/AI/udemy/AI Coder Complete Claude Code & Coding Agents Course/Project_Files/finally/.claude/settings.json` (global) — **not** in `.planning/config.json`:
